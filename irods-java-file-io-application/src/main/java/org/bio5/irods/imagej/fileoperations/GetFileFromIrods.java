...
public class GetFileFromIrods extends SwingWorker<Void, Integer> {
	...
	public Void doInBackground() throws Exception {
		...
		// Get file to local directory using getDataTransferOperations --- Need
		// to check benchmarks
		...
		try {
			if (null != sourceIrodsFilePath) {
				...
				dataTransferOperationsAO.getOperation(sourceIrodsFilePath,
						destinationLocalFilePath, null, null);
			}
